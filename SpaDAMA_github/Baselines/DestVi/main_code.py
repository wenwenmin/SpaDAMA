...
def main(a,b,cell_key):
    ...
    for i in range(a, b):
        sc_file = 'Datasets/preproced_data\dataset_sim' + str(i) + '\Scdata_filter.h5ad'
        st_file = 'Datasets/preproced_data\dataset_sim' + str(i) + '\Real_STdata_filter.h5ad'
        ...
        outpath = 'Baselines/DestVi\Result/' + 'dataset_sim' + str(i)
